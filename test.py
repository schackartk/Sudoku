...
def test_bad_difficulty():
    ...
    bad_d = random.choice(['a','b','c','d','f','g','i','j','k','l','n','o','p','q','r','s','t','u','v','w','x','y','z'])
...
def test_make_board():
    ...
    assert sudoku.make_board('E') == [[' ',' ',' ', 'b','f',' ', 'g',' ','a'], ['f','h',' ', ' ','g',' ', ' ','i',' '], ['a','i',' ', ' ',' ','d', 'e',' ',' '], ['h','b',' ', 'a',' ',' ', ' ','d',' '], [' ',' ','d', 'f',' ','b', 'i',' ',' '], [' ','e',' ', ' ',' ','c', ' ','b','h'], [' ',' ','i', 'c',' ',' ', ' ','g','d'], [' ','d',' ', ' ',' ','e', ' ','c','f'], ['g',' ','c', ' ','a','h', ' ',' ',' ']]

    assert sudoku.make_board('M') == [[' ','b',' ', 'f',' ','h', ' ',' ',' '], ['e','h',' ', ' ',' ','i', 'g',' ',' '], [' ',' ',' ', ' ','d',' ', ' ',' ',' '], ['c','g',' ', ' ',' ',' ', 'e',' ',' '], ['f',' ',' ', ' ',' ',' ', ' ',' ','d'], [' ',' ','h', ' ',' ',' ', ' ','a','c'], [' ',' ',' ', ' ','b',' ', ' ',' ',' '], [' ',' ','i', 'h',' ',' ', ' ','c','f'], [' ',' ',' ', 'c',' ','f', ' ','i',' ']]

    assert sudoku.make_board('H') == [[' ',' ',' ', 'f',' ',' ', 'd',' ',' '], ['g',' ',' ', ' ',' ','c', 'f',' ',' '], [' ',' ',' ', ' ','i','a', ' ','h',' '], [' ',' ',' ', ' ',' ',' ', ' ',' ',' '], [' ','e',' ', 'a','h',' ', ' ',' ','c'], [' ',' ',' ', 'c',' ','f', ' ','d','e'], [' ','d',' ', 'b',' ',' ', ' ','f',' '], ['i',' ','c', ' ',' ',' ', ' ',' ',' '], [' ','b',' ', ' ',' ',' ', 'a',' ',' ']]
...
def test_modify_board():
    ...
    assert changed_cells == [['1', ' ', '5', ' ', '3', '6', ' ', ' ', ' '], [' ', '8', ' ', ' ', ' ', '7', ' ', '5', '4'], [' ', ' ', '9', '5', ' ', ' ', ' ', '1', '8'], [' ', '7', ' ', ' ', ' ', '5', ' ', '2', '6'], [' ', ' ', '8', '4', ' ', '2', '9', ' ', ' '], ['6', '2', ' ', '3', ' ', ' ', ' ', '8', ' '], ['3', '9', ' ', ' ', ' ', '8', '7', ' ', ' '], ['4', '6', ' ', ' ', '1', ' ', ' ', '9', ' '], [' ', ' ', ' ', '2', '4', ' ', '1', ' ', '3']]

    assert immut == [(0, 0), (0, 2), (0, 4), (0, 5), (1, 1), (1, 5), (1, 7), (1, 8), (2, 2), (2, 3), (2, 7), (2, 8), (3, 1), (3, 5), (3, 7), (3, 8), (4, 2), (4, 3), (4, 5), (4, 6), (5, 0), (5, 1), (5, 3), (5, 7), (6, 0), (6, 1), (6, 5), (6, 6), (7, 0), (7, 1), (7, 4), (7, 7), (8, 3), (8, 4), (8, 6), (8, 8)]
